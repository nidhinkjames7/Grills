<%@ Page Language="C#" AutoEventWireup="true" CodeFile="removefood.aspx.cs" Inherits="removefood" %>
                                ...
                                <form runat="server">
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="food_id" DataSourceID="SqlDataSource1">
                                        <Columns>
                                            ...
                                            <asp:ButtonField CommandName="Delete" Text="Remove Food" ButtonType="Button" ShowHeader="True" HeaderText="Remove Food"></asp:ButtonField>
                                        </Columns>
                                    </asp:GridView>
                                    <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:grillConnectionString %>' SelectCommand="SELECT * FROM [addfood]" DeleteCommand="DELETE FROM [addfood] where food_id=@food_id"></asp:SqlDataSource>
                                </form>
                        </div>
				    </div>
			    </div>
